...
export interface APOIndicatorConfig
  extends IInputTypeConfig,
    ILongShortPeriodConfig {}
...
export interface EDECAYIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
...
export interface LINREGIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
export interface LINREGINTERCEPTIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
export interface LINREGSLOPEIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
...
export interface PPOIndicatorConfig
  extends IInputTypeConfig,
    ILongShortPeriodConfig {}
...
export interface STDDEVIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
export interface STDERRIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
...
export interface STOCHRSIIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
export interface SUBIndicatorConfig extends IDoubleInputTypeConfig {}
export interface SUMIndicatorConfig
  extends IDoubleInputTypeConfig,
    IPeriodConfig {}
...
export interface VIDYAIndicatorConfig
  extends IInputTypeConfig,
    ILongShortPeriodConfig {
  alpha: number;
}
export interface VOLATILITYIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
export interface VOSCIndicatorConfig
  extends IInputTypeConfig,
    ILongShortPeriodConfig {}
...
export interface WILDERSIndicatorConfig
  extends IInputTypeConfig,
    IPeriodConfig {}
